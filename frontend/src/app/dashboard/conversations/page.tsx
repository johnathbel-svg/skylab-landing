    ...
    return (
        <div className="flex flex-col h-full bg-background relative">
            ...
            <main className="flex-1 overflow-y-auto w-full max-w-[1600px] mx-auto p-6 lg:p-10 space-y-8 relative z-10">
                ...
                {/* Main Table Content */}
                <div className="bg-[#0B0F17] dark:bg-[#0B0F17] rounded-[40px] border border-white/10 dark:border-white/10 shadow-2xl overflow-hidden group">
                    <Table>
                        <TableHeader className="bg-[#0B0F17] dark:bg-transparent border-b border-white/10 ">
                            <TableRow className="border-none hover:bg-transparent">
                                <TableHead className="font-black text-[#7E8A9C] dark:text-[#A6B3C4] h-14 uppercase text-[10px] tracking-widest pl-8">Estado / ID</TableHead>
                                <TableHead className="font-black text-[#7E8A9C] dark:text-[#A6B3C4] h-14 uppercase text-[10px] tracking-widest">Cliente</TableHead>
                                <TableHead className="font-black text-[#7E8A9C] dark:text-[#A6B3C4] h-14 uppercase text-[10px] tracking-widest">IA Asignada</TableHead>
                                <TableHead className="font-black text-[#7E8A9C] dark:text-[#A6B3C4] h-14 uppercase text-[10px] tracking-widest">Vía</TableHead>
                                <TableHead className="font-black text-[#7E8A9C] dark:text-[#A6B3C4] h-14 uppercase text-[10px] tracking-widest text-right pr-8">Cronología</TableHead>
                            </TableRow>
                        </TableHeader>
                        <TableBody>
                                ...
                                <TableRow className="hover:bg-transparent border-none">
                                    <TableCell colSpan={5} className="h-[400px] text-center">
                                        <div className="flex flex-col items-center justify-center gap-6 animate-in fade-in duration-700">
                                            <div className="w-20 h-20 bg-[#0B0F17] dark:bg-[#0B0F17] border border-white/10 dark:border-white/10 rounded-[32px] flex items-center justify-center">
                                                <MessageSquareText className="w-10 h-10 text-slate-300 dark:text-white/20" />
                                            </div>
                                            <div className="space-y-2">
                                                <p className="text-xl font-black text-white dark:text-white tracking-tighter leading-none">Cero Intercepciones</p>
                                                <p className="text-xs text-[#7E8A9C] font-medium font-mono uppercase">Protocolo de escucha activo...</p>
                                            </div>
                                            <SeedDataButton className="bg-[#0B0F17] dark:bg-[#0B0F17] border-white/10 dark:border-white/10 text-white dark:text-white rounded-2xl px-8 h-12" />
                                        </div>
                                    </TableCell>
                                </TableRow>
                            ) : (
                                conversations.map((conv) => (
                                    <TableRow key={conv.id} className="border-b border-slate-50  hover:bg-[#0B0F17] dark:hover:bg-[#0B0F17] transition-all group cursor-pointer h-24">
                                        <TableCell className="pl-8">
                                            <div className="flex flex-col gap-2">
                                                <Badge className={`capitalize inline-flex w-max font-black text-[9px] tracking-widest shadow-none px-3 py-1 border-none rounded-full ${conv.status === 'open' ? 'bg-emerald-500/10 text-emerald-500' : 'bg-[#0B0F17]0/10 text-[#A6B3C4]'}`}>
                                        ...
                                        <TableCell>
                                            <div className="flex items-center gap-4">
                                                <div className="w-11 h-11 rounded-2xl bg-slate-900 dark:bg-[#0B0F17] border border-white/10 flex items-center justify-center text-white dark:text-white text-xs font-black">
                                                    {(conv.contacts?.name || 'U').charAt(0).toUpperCase()}
                                                </div>
                                                <div className="flex flex-col">
                                                    <span className="text-sm font-black text-white dark:text-white tracking-tight group-hover:text-emerald-500 transition-colors">
                                        ...
                                        <TableCell>
                                            <div className="flex items-center gap-2 bg-[#00B4DB]/10 dark:bg-[#0B0F17] border border-[#00B4DB]/30/20 dark:border-white/10 px-3 py-1.5 rounded-xl w-max">
                                                <Bot className="w-3.5 h-3.5 text-[#00B4DB] dark:text-indigo-400" />
                                                <span className="text-[10px] font-black text-[#00B4DB] dark:text-indigo-300 uppercase tracking-widest">
                                        ...
                                        <TableCell>
                                            <div className="flex items-center gap-2">
                                                ...
                                                <span className="text-[10px] font-black capitalize text-[#A6B3C4] dark:text-[#7E8A9C] uppercase tracking-widest">
                                                    {conv.channel}
                                                </span>
                                            </div>
                                        </TableCell>
                                        <TableCell className="text-right pr-8">
                                            <div className="flex items-center justify-end gap-4">
                                                <div className="flex flex-col items-end">
                                                    <span className="text-white dark:text-white text-xs font-black">
